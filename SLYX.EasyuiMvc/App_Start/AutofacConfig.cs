...
namespace SLYX.EasyuiMvc.App_Start
{
    public class AutofacConfig
    {
        ...
        public static void Register()
        {
            ...
            Assembly controllerAss = Assembly.Load("SLYX.EasyuiMvc");
            builder.RegisterControllers(controllerAss);

            //告诉autofac框架注册数据仓储层所在程序集中的所有类的对象实例
            Assembly respAss = Assembly.Load("SLYX.DAL");
            ...
            Assembly serpAss = Assembly.Load("SLYX.BLL");
